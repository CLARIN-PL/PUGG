...
class OneHopTemplate(BaseTemplate):
    max_response_count = 10
    keys_to_extract = ["mainEntity", "mainEntityLabel", "relation", "relationLabel"]
...
"""
    ...
    def get_question_pattern(self) -> str:
        question_template = "Jakie {relationLabel} ma {mainEntityLabel}?"
