"""
This file is a copy of beir library implementation of ElasticSearch.
...
class ElasticSearch(object):
    ...
    def create_index(self):
        ...
        try:
            ...
            mapping = {
                ...
                "mappings": {
                    "properties": {
                        self.title_key: {"type": "text", "analyzer": "lang_pl_morfologik"},
                        self.text_key: {"type": "text", "analyzer": "lang_pl_morfologik"},
                    }
                },
            }
    ...
    def lexical_search(
        ...
        if ids:
            req_body = {
                "query": {"bool": {"must": req_body["query"], "filter": {"ids": {"values": ids}}}}
            }
