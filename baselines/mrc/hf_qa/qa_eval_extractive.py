...
class DataTrainingArguments:
    ...
    only_possible: Optional[bool] = field(
        default=False, metadata={"help": "Load only possible questions."}
    )
    normalize_answers: Optional[bool] = field(
        default=False, metadata={"help": "Normalize yes/no answers."}
    )
    without_decision_questions: Optional[bool] = field(
        default=False, metadata={"help": "Deleting from dataset decision questions"}
    )
    only_decision_questions: Optional[bool] = field(
        default=False, metadata={"help": "Load only decision questions."}
    )
...
def main():
    ...
    start_idx_column_name = "start_idx"
        ...
        references = [
            {
                "id": ex["id"],
                "answers": [
                    {"text": ex[answer_column_name], "answer_start": ex[start_idx_column_name]}
                ],
            }
            for ex in examples
        ]
